...
repo --name=1.3-trimslice --baseurl=http://repo.pub.meego.com/home:/cxl000:/trimslice:/m13/DE_Trunk_Testing --save --debuginfo --source --gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-meego
...
xorg-x11-utils-xev
xorg-x11-drv-tegra-api10
nvidia-tegra2
nvidia-tegra2-devel
nvidia-tegra2-libEGL
nvidia-tegra2-libEGL-devel
nvidia-tegra2-libGLESv1-devel
nvidia-tegra2-libGLESv2
nvidia-tegra2-libGLESv2-devel
nvidia-tegra2-libopenmax
nvidia-tegra2-libopenmax-devel
xterm
-mesa-libGLESv2
-mesa-libEGL
...
-libcal-rx-51-bin
-sysinfod-rx51-bin
-sysinfod-rx51-udev-rules
-sysinfod-rx51-common-bin
-sysinfod-rx51-tool-bin
-libsysinfo-rx51-bin
...
-pulseaudio-modules-n900-common
